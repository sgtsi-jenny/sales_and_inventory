              ...
              <div class="box box-primary">
                <div class="box-body">
                    ...
                    <table id='ResultTable' class='table table-bordered table-striped'>
                          ...
                          <tbody>
                                            <?php
                                                $supplier=$con->myQuery("SELECT name,description, contact_number,address,email,id
FROM suppliers 
WHERE is_deleted=0")->fetchAll(PDO::FETCH_ASSOC);
                                            ...
                                            ?>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class='btn btn-sm btn-warning' href='frm_supplier.php?id=<?php echo $row['id'];?>'><span class='fa fa-pencil'></span></a>
