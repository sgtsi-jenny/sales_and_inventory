...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      if (this.showInputs) {
        hourTemplate = '<input type="text" name="hour" class="numeric bootstrap-timepicker-hour form-control" maxlength="2" readonly/>';
        minuteTemplate = '<input type="text" name="minute" class="numeric bootstrap-timepicker-minute form-control" maxlength="2" readonly/>';
        secondTemplate = '<input type="text" name="second" class="numeric bootstrap-timepicker-second form-control" maxlength="2" readonly/>';
        meridianTemplate = '<input type="text" name="meridian" class="bootstrap-timepicker-meridian form-control" maxlength="2" readonly/>';
      } else {
