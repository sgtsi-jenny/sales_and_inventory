<?php
    ...
    if(!empty($_GET['id']))
    {
        $sales_order=$con->myQuery("SELECT * FROM sales WHERE sales_id=?",array($_GET['id']))->fetch(PDO::FETCH_ASSOC);
                        ...
                        <div class="box-body">
                            <div class='form-group'>
                                <div class ="row">
                                    ...
                                    <div class = "col-md-8  ">
                                        <select class='form-control' id='product_id' onchange='get_price2()' name='product_id' data-placeholder="Select a product" <?php echo!(empty($data))?"data-selected='".$data['product_id']."'":NULL ?>style='width:100%' required >
